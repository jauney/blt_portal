layui.define(['jquery',], function (exports) {
    ...
    function SiriWave(opt) {
        ...
        document.getElementById('showRange').appendChild(this.canvas);
    ...
    SiriWave.prototype = {
        ...
        _draw: function () {
            ...
            this._clear();
            this._drawLine(-2, 'rgba(0,158,136,0.1)');
            this._drawLine(-6, 'rgba(255,87,34,1)');
            this._drawLine(4, 'rgba(30,159,255,0.4)');
            this._drawLine(2, 'rgba(255,184,1,0.6)');
            this._drawLine(1, 'rgba(45,181,163,1)', 1.5);
